    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            ...
            <ul class="navbar-nav" id="nav-left">
                <li class="nav-item active">
                    <a class="nav-link" id="home1"
                       href="/index.php?page=usershomepage">Home</a>
                </li>
                <li class="nav-item active">
...
<div class="jumbotron" id="jumb0">
    <div class="container-fluid padding">
        ...
        <div class="row text-center padding">
            ...
            <br>
            <div class="col-xs-12 col-sm-4 col-lg-3 text-center">
                <img src="/Views/img/default_avatar.jpg">
            </div>
            <div class="col-xs-12 col-sm-4 col-lg-3 text-center" id="formAddMovie">
                ...
                <form id="insertAllForm">
                    ...
                    <button type="reset" id="btnInsertall" value="insertactorsinmovies" class="btn btn-primary btn-lg">
                        Insert
                    </button>
            ...
            <div class="col-xs-12 col-sm-4 col-lg-3 text-center" id="formAddMovie">
                ...
                <form id="insertAllForm1">
                    ...
                    <button type="reset" id="btnInsertall1" value="insertgenresinmovies" class="btn btn-primary btn-lg">
                        Insert
                    </button>
