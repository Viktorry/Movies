    ...
    <div class="container-fluid padding">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4 col-lg-2" style="text-align:center">
                <img src="/Views/img/index.jpeg" href="" class="img-thumbnail">
                <?php
                $novi = new Controller();
            ...
            <div class="col-xs-12 col-sm-4 col-lg-2" style="text-align:center">
                <img src="/Views/img/gf3.jpeg" class="img-thumbnail">
                <?php
            ...
            <div class="col-xs-12 col-sm-4 col-lg-2" style="text-align:center">
                <img src="/Views/img/index.jpg" class="img-thumbnail">
            ...
            <div class="col-xs-12 col-sm-4 col-lg-2" style="text-align:center">
                <img src="/Views/img/Inception.jpeg" class="img-thumbnail">
            ...
            <div class="col-xs-12 col-sm-4 col-lg-2" style="text-align:center">
                <img src="/Views/img/fc1.jpeg" class="img-thumbnail">
