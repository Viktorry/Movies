<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/movies-new/Controller/Controller.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/movies-new/Model/Model.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link href="/movies-new/Views/FightClub.css" rel="stylesheet">
