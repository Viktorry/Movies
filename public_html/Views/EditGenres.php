                ...
                <form class="form-horizontal" id="form">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="fname" name="genres" type="text" placeholder="EditGenre"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-md-12 text-center">
                                <button type="reset" id="btnInsert" value="editgenres" class="btn btn-primary btn-lg"
                                        style="background: 	#100b0a;border-color: 	#100b0a">EditGenre
                                </button>
                            </div>
                        </div>
