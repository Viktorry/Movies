                ...
                $.ajax({
                    ...
                    success: function (output) {
                        if (jQuery.trim(output) == "User") {
                            window.location = '/Views/UsersPage.php';
                        } else {
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            ...
            <ul class="navbar-nav" id="nav-left">
                <li class="nav-item active">
                    <a class="nav-link" href="/index.php?page=user">UsersPage</a>
                </li>
                <li class="nav-item active">
    ...
    <div id="slides" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class=" carousel-item active">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-xl-12">
                        <img src="/Views/img/Joker3.jpg" class="Cour">
            ...
            <div class=" carousel-item ">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-xl-12">
                        <img src="/Views/img/inception-wallpapers-8.jpg" class="Cour">
                        <div class="carousel-caption text-center">
            ...
            <div class=" carousel-item ">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-xl-12">
                        <img src="/Views/img/Peaky3.jpg" class="Cour">
                        <div class="carousel-caption text-center">
    ...
    <div class="container-fluid padding">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4 col-lg-2">
                <img src="/Views/img/Sl2.jpg" class="img-thumbnail">
            </div>
