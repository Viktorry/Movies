                ...
                <form class="form-horizontal" id="form">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="fname" name="movie" type="text" placeholder="InsertMovie"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="fname" name="duration" type="text" placeholder="InsertDuration"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="fname" name="ratings" type="text" placeholder="InsertRatings"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="fname" name="youtube" type="text" placeholder="InsertYoutube"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-md-12 text-center">
                                <button type="reset" id="btnInsert" value="InsertMovie" class="btn btn-primary btn-lg"
                                        style="background: 	#100b0a;border-color: 	#100b0a">Insert
                                </button>
                            </div>
                        </div>
                    </fieldset>
